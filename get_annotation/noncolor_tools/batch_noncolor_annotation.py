...
if __name__ == "__main__":
    ...
    save_dir_org = "/home/sunzc/VisDroneAnnotation/train_noncolor_annotation"
    if not os.path.exists(save_dir_org):
        os.makedirs(save_dir_org)
    save_dir_new = "/home/sunzc/VisDroneAnnotation/train_noncolor_annotation"


    all_image_dir = "/data/sunzc/VisDrone2019/all_image"
    prompt_dir = "/home/sunzc/chatgpt/prompts/annotation_example_noncolor_v3"

    caption_dir = "/home/sunzc/VisDroneAnnotation/train_caption"

    color_info_dir = "/home/sunzc/VisDrone2019/train_anchor_normalize_noncolor"


    batch_noncolor_annotator = BatchAnnotatorNonColorV3(prompt_dir=prompt_dir, info_dir=color_info_dir, caption_dir=caption_dir, image_dir=image_dir, save_dir=save_dir_new, all_image_dir=all_image_dir, n=1)
    ...
    for image_name in image_names:
        ...
        cap_json = batch_noncolor_annotator.create_json(image_name)
    ...
    with open("batch_noncolor_caption_input_file_ids.txt", "w") as f:
